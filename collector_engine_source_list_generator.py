...
with tqdm(
    ...
    for index, row in sources_df.iterrows():
        ...
        is_rss_feed_valid = (
            check_feed_validity(rss_url) if is_rss_feed_available else False
        )
        ...
        usable_source_count += usable_source
...
print(f"Percentage of usable sources: {usable_source_count/total_source_count:.2%}")
